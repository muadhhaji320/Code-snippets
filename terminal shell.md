...
```shell
$ ls -l  // This command lists the files in the current directory
...
$ echo "This is a comment. It does not affect the command execution."
...
# Archive files into a compressed format
